...
function Buttons() {
    return (
        <div className="flex mt-6">
            <a href="https://drive.google.com/file/d/1P5Jpw77FXhT36Lv_07tr3FK9403QK8Of/view?usp=sharing" target="_blank" rel="noreferrer" class="block px-6 py-2 text-xs font-semibold text-white bg-red-500 rounded-md hover:bg-red-400 lg:transform lg:hover:scale-110 lg:duration-500">
                Resume
            </a>
