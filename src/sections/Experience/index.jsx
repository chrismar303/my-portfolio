        ...
        <main id="experience" className="flex flex-col justify-center items-center bg-gray-50">
            <Section title="Relevant Experience" subtitle="Where I am at!">
                <div className="w-3/5 m-auto">
                    ...
                    <ul class="list-disc flex flex-col gap-2 mt-4 ml-4">
                        ...
                        <li>Collaborated on an scrum team of 7 and helped design and develop features based on user stories, requirements, and design requirements</li>
                    </ul>
                    <div className="mt-8">
